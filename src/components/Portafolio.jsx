			...
			<Container fluid='true' className='section-1' as='section'>
					...
					<Row>
						<Col className='p-4'>
							<Card className='card-light'>
								<h4>Soluciones Integrales para la Gestión de Desechos Biológicos</h4>
								<p>
									<br />
						...
						<Col className='p-4'>
							<Card className='card-color'>
								...
								<p>
									...
									adaptado a las necesidades específicas de clínicas, hospitales y laboratorios. Beneficios: Reducción
									de riesgos para la salud y el medio ambiente mediante prácticas seguras y reguladas. Transporte
									Especializado
									<br />
				...
				<Container as='main'>
					<Row>
						<Col className='p-4'>
							<Card className='card-color'>
								<h4>Principios y Desafíos Abordados</h4>
								<p>
									...
									rigurosos y tecnologías avanzadas para garantizar una recolección y disposición final seguras,
									mitigando los riesgos de contaminación y exposición. Costos Elevados
									<br />
									...
									servicios de manera sostenible pueden obstaculizar el crecimiento de las empresas. Solución de
									BioSalud S.A.S: Ofrecemos soluciones escalables y flexibles que permiten a nuestros clientes adaptarse
									a las cambiantes necesidades del mercado, promoviendo un crecimiento sostenible y eficiente.
								</p>
							</Card>
						</Col>
						<Col className='p-4'>
